...
//     this.ws = new WebSocket("ws://" + document.location.hostname + ":3003");
...
//       console.error("WebSocket is not connected. Cannot send request:", method);
//       return;
//     }
...
//     console.log("connectCallback called with data:", data);
